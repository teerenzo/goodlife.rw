...
<div class="mt-5">
<span class="subheading">Welcome to Goodlife</span>
<h2 class="mb-4">Retail Health and Personal Care Products.</h2>
<p class="mb-4">Goodlife Health and Beauty is a leading retail, pharmaceutical and cosmetic group in Rwanda.</p>
<p><a href="#" class="btn btn-primary py-3 px-4">Visit our branches</a></p>
</div>
</div>
</div>
</div>
...
<div class="media-body pl-md-4">
<h3 class="heading mb-3"> Branches</h3>
<p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
</div>
</div>
</div>
